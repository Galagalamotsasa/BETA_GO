...
<body>
		...
		<form action="./boardController.bo?" method="post" enctype="multipart/form-data">
		...
		<div class="form-group">
			<label for="usr">제목:</label> <input type="text" class="form-control" id="title" name="title" required="required">
		</div>
		<div class="form-group">
			<label for="comment">내용:</label>
			<textarea class="form-control" rows="5" id="comment" name="content" required="required"></textarea>
		</div>
		<label for="comment">파일:</label> <input type="file" class="form-control-file border" name="board_img" id="board_img">
