...
public class login implements IBetagoAction {
	...
	@Override
	public BetagoActionForward execute(HttpServletRequest request, HttpServletResponse response) throws ClassNotFoundException, NamingException, SQLException, IOException {
