...
public class ChapterJoinVideo {
	private int chapter_no;
	private int class_no;
	private String chapter_title;
	private String chapter_object;
	private String chapter_detail;
	private Date chapter_startdate;
	private Date chapter_enddate;
	private int video_no;
	private String video_title;
	private String video_thumbnail;
	
	public ChapterJoinVideo(int chapter_no, int class_no, String chapter_title, String chapter_object,
			String chapter_detail, Date chapter_startdate, Date chapter_enddate, int video_no, String video_title,
	...
	public String toString() {
		return "ChapterJoinVideo [chapter_no=" + chapter_no + ", class_no=" + class_no + ", chapter_title="
				+ chapter_title + ", chapter_object=" + chapter_object + ", chapter_detail=" + chapter_detail
				+ ", chapter_startdate=" + chapter_startdate + ", chapter_enddate=" + chapter_enddate + ", video_no="
				+ video_no + ", video_title=" + video_title + ", video_thumbnail=" + video_thumbnail + "]";
	}
